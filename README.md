...
## ゲームUIを“プロっぽく”するためのルール（重要）

UIが「なんかイマイチ」になりがちな原因（余白/情報階層/状態/一貫性）を潰すため、**UI設計スキル集**を用意しています。新規ゲーム作成時やUI磨き込み時はこれを参照してください：

- `.cursor/rules/15-game-ui-design-skills.mdc`
